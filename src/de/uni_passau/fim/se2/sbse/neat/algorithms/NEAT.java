...
public class NEAT implements Neuroevolution {
    ...
    public NEAT(int populationSize, int maxGenerations, double mutationRate, double crossoverRate, Random random) {
    ...
    private void initializePopulation() {
        for (int i = 0; i < populationSize; i++) {
            NetworkChromosome chromosome = new NetworkGenerator(innovations, 2, 1, random).generate();
    ...
    public Agent solve(Environment environment) {
        for (generation = 0; generation < maxGenerations; generation++) {
            ...
            //System.out.println("Generation " + generation + " Best Fitness: " + getBestFitness());
